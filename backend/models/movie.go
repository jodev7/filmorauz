...
type Movie struct {
	...
	// Hover-preview thumbnails (generated by worker, every ThumbnailInterval seconds).
	// Frontend builds <ThumbnailsBaseURL>thumb-<floor(t/interval)+1>.jpg.
...
func (m *MovieInput) UnmarshalJSON(data []byte) error {
	...
	*m = MovieInput{
		...
		AvailableQualities: aux.AvailableQualities,
