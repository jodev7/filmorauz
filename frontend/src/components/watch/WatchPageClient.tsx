  ...
  return (
    <div className={embedded ? "" : "pt-20 sm:pt-24 min-h-screen"}>
      ...
      <div className={embedded ? "" : "max-w-6xl mx-auto px-3 sm:px-4 pt-4 sm:pt-6 pb-6 sm:pb-8"}>
        {/* Source MP4 download — admins/superadmins only for now. Rendered
            above the player so it shows in BOTH the standalone watch page and
            the embedded movie-page player. Backend also permits premium users,
            but no button is exposed to them yet. HLS sources only. */}
        {movie && token &&
            ...
            return (
              <div className="mb-3 flex justify-end">
                <a
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-2 glass-card border border-white/10 hover:border-brand-red rounded-lg text-xs sm:text-sm text-white transition-colors whitespace-nowrap"
                  title="Eng yuqori sifatda yuklab olish (1080p/720p)"
                >
                  <Download size={15} />
