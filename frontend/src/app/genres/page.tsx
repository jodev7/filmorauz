          ...
          <div className="flex flex-wrap gap-3">
            {genres.map((genre) => (
              <Link
                key={genre}
                href={`/genres/${genre}`}
                className="rounded-full border border-brand-border bg-brand-card px-4 py-2 text-sm text-gray-200 hover:border-brand-red hover:text-white transition-colors"
              >
